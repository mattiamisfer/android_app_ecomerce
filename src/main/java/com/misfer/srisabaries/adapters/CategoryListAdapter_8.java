...
import com.misfer.srisabaries.fragment.SubCategories_1;
...
public class CategoryListAdapter_8 extends RecyclerView.Adapter<CategoryListAdapter_8.MyViewHolder> {
    ...
    public CategoryListAdapter_8(Context context, List<CategoryDetails> categoriesList, List<CategoryDetails> allCategoriesList, boolean isSubCategory) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_categories_8, parent, false);
