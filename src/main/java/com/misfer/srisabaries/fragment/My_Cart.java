...
import com.misfer.srisabaries.adapters.CartItemsAdapter;
...
public class My_Cart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        cartItemsAdapter = new CartItemsAdapter(getContext(), finalCartItemsList, com.misfer.srisabaries.fragment.My_Cart.this);
                    ...
                    if (ConstantValues.MAINTENANCE_MODE.equalsIgnoreCase("Maintenance"))
                        ...
                        if (cartItemsList.size() != 0) {
                            ...
                            if (ConstantValues.IS_USER_LOGGED_IN) {
                                ...
                                Fragment fragment = new Shipping_Address(com.misfer.srisabaries.fragment.My_Cart.this);
                                FragmentManager fragmentManager = getFragmentManager();
            ...
            public void onResponse(Call<ProductData> call, Response<ProductData> response) {
                if (response.isSuccessful()) {
                    if (response.body().getSuccess().equalsIgnoreCase("1")) {
                        ...
                        cartItemsAdapter = new CartItemsAdapter(getContext(), allNEwCartItemList, com.misfer.srisabaries.fragment.My_Cart.this);
