...
import com.misfer.srisabaries.adapters.ViewPagerCustomAdapter;
...
public class HomePage_7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.homepage_7, container, false);
    ...
    public void continueSetup() {
        ...
        fragmentManager.beginTransaction().replace(R.id.home7_categories, categories).commit();

        allProducts = new All_Products();
        Bundle bundleInfo = new Bundle();
        bundleInfo.putString("sortBy", "Newest");
        allProducts.setArguments(bundleInfo);
        fragmentManager.beginTransaction().replace(R.id.home7_products_fragment, allProducts).commit();
    ...
    private void setupBannerSlider(final List<BannerDetails> bannerImages) {
        ...
        if (bannerStyle != null)
            fragmentManager.beginTransaction().replace(R.id.bannerFrameHome7, bannerStyle).commit();
    }
