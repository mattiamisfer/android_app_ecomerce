...
public class BannerStyle3 extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    public BannerStyle3(List<BannerDetails> bannerImages, List<CategoryDetails> allCategoriesList) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.banner_style_3, container, false);
