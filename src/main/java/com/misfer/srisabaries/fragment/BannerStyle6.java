...
public class BannerStyle6 extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    public BannerStyle6(List<BannerDetails> bannerImages, List<CategoryDetails> allCategoriesList) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.banner_style_6, container, false);
    ...
    public void onSliderClick(BaseSliderView slider) {
        ...
        if (type.equalsIgnoreCase("product")) {
            if (!TextUtils.isEmpty(url)) {
                ...
                // Navigate to Product_Description of selected
