...
public class BannerStyle2ViewPager extends ViewPager implements ViewPager.PageTransformer {
    public static final String TAG = "BannerStyle2ViewPager";
    ...
    public BannerStyle2ViewPager(Context context) {
        this(context, null);
    }

    public BannerStyle2ViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void transformPage(View page, float position) {
        ...
        if (MAX_SCALE == 0.0f && position > 0.0f && position < 2.0f) {
            MAX_SCALE = position;
        }
